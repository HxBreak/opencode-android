...
class ChatViewModelTest {
    ...
    fun setup() {
        ...
        mentionManagementUseCase = MentionManagementUseCase(api, eventReducer, serverRepository, errorCollector)
        ...
        modelSelectionUseCase = ModelSelectionUseCase(api, eventReducer, serverRepository, settingsRepository, metadataCache, errorCollector)
